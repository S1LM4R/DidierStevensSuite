...
setup(
    ...
    install_requires=['pillow', 'poster', 'simplejson'],
...
'decoder_add1.py=didierstevenssuite.decoder_add1:Main',
'decoder_ah.py=didierstevenssuite.decoder_ah:Main',
'decoder_chr.py=didierstevenssuite.decoder_chr:Main',
'decoder_rol1.py=didierstevenssuite.decoder_rol1:Main',
'decoder_xor1.py=didierstevenssuite.decoder_xor1:Main',
...
'mPDF.py=didierstevenssuite.mPDF:Main',
...
'naft_impf.py=didierstevenssuite.naft_impf:Main',
'naft_pfef.py=didierstevenssuite.naft_pfef:Main',
...
'plugin_biff.py=didierstevenssuite.plugin_biff:Main',
'plugin_dridex.py=didierstevenssuite.plugin_dridex:Main',
'plugin_embeddedfile.py=didierstevenssuite.plugin_embeddedfile:Main',
'plugin_http_heuristics.py=didierstevenssuite.plugin_http_heuristics:Main',
'plugin_jumplist.py=didierstevenssuite.plugin_jumplist:Main',
'plugin_nameobfuscation.py=didierstevenssuite.plugin_nameobfuscation:Main',
'plugin_triage.py=didierstevenssuite.plugin_triage:Main',
'plugin_vba_summary.py=didierstevenssuite.plugin_vba_summary:Main',
'reextra.py=didierstevenssuite.reextra:Main',
